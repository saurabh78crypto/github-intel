...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      setError(
        msg.toLowerCase().includes('conflict') || msg.toLowerCase().includes('already')
  ...
  const pwColor = ['transparent', '#ef4444', '#f59e0b', '#10b981'][pwStrength];
  const pwWidth = ['0%', '30%', '65%', '100%'][pwStrength];
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-subtitle {
          font-size: 15px; color: rgba(148,163,184,0.55); line-height: 1.6;
        }
        .auth-card {
        ...
        .auth-input.match { border-color: rgba(16,185,129,0.45); }
        .auth-input.mismatch { border-color: rgba(239,68,68,0.45); }
        ...
        .auth-terms {
          font-size: 12px; color: rgba(148,163,184,0.35);
        ...
        <div className="auth-wrap">
          ...
          <div className="auth-card">
            ...
            <div className="auth-field">
              ...
              {password.length > 0 && (
                <div className="pw-strength-bar">
                  <div className="pw-strength-fill" style={{ width: pwWidth, background: pwColor }} />
                </div>
              )}
            </div>
            ...
            <div className="auth-field">
              ...
              <input
                type="password"
                className={`auth-input${confirmMatch ? ' match' : confirmMismatch ? ' mismatch' : ''}`}
